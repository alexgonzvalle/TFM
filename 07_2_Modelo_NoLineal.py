...
for nombre in df_boya['Nombre']:
    ...
    params, params_covariance = curve_fit(model_function, X, hs_cal_gow, p0=[1, 1])
    beta_gow_cal, gamma_gow_cal = params
    y_cal_gow = beta_gow_cal * x_plot ** gamma_gow_cal  # ((1 / beta_gow) ** (1 / gamma_gow)) * x_plot ** (1 / gamma_gow)

    y_raw_cop = beta_cop * x_plot ** gamma_cop

    params, params_covariance = curve_fit(model_function, X, hs_cal_cop, p0=[1, 1])
    beta_cop_cal, gamma_cop_cal = params
    y_cal_cop = beta_cop_cal * x_plot ** gamma_cop_cal  # ((1 / beta_cop) ** (1 / gamma_cop)) * x_plot ** (1 / gamma_cop)
